        ...
        <div class="card-body">
            <form action="{{ route('admin.links.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="youtube_link" class="form-control @error('youtube_link') is-invalid @enderror" placeholder="https://youtube.com/in/username" value="{{ old('youtube_link') }}">
